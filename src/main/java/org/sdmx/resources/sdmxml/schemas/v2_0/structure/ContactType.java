 ...
 *         &lt;element name="id" type="{http://www.SDMX.org/resources/SDMXML/schemas/v2_0/common}IDType" minOccurs="0"/>
...
public class ContactType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "Telephone", namespace = "http://www.SDMX.org/resources/SDMXML/schemas/v2_0/structure", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "URI", namespace = "http://www.SDMX.org/resources/SDMXML/schemas/v2_0/structure", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Email", namespace = "http://www.SDMX.org/resources/SDMXML/schemas/v2_0/structure", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "X400", namespace = "http://www.SDMX.org/resources/SDMXML/schemas/v2_0/structure", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Fax", namespace = "http://www.SDMX.org/resources/SDMXML/schemas/v2_0/structure", type = JAXBElement.class, required = false)
    })
