...
public class RepresentationSchemeType {
    ...
    @XmlAttribute(name = "representationScheme", required = true)
    protected String representationScheme;
    @XmlAttribute(name = "representationSchemeAgency", required = true)
    protected String representationSchemeAgency;
    @XmlAttribute(name = "representationSchemeType", required = true)
