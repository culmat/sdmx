 ...
 * 
 * <p>Java class for PartialTargetIdentifierType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PartialTargetIdentifierType">
 *   &lt;complexContent>
 ...
 *         &lt;element name="IdentifierComponentRef" type="{http://www.SDMX.org/resources/SDMXML/schemas/v2_0/common}IDType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "PartialTargetIdentifierType", propOrder = {
    "name",
    "description",
    "identifierComponentRef",
    "annotations"
})
public class PartialTargetIdentifierType {
    ...
    @XmlElement(name = "IdentifierComponentRef")
    protected List<String> identifierComponentRef;
    ...
    /**
     * Gets the value of the identifierComponentRef property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the identifierComponentRef property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getIdentifierComponentRef().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getIdentifierComponentRef() {
        if (identifierComponentRef == null) {
            identifierComponentRef = new ArrayList<String>();
        }
        return this.identifierComponentRef;
    }
